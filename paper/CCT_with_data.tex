...
\begin{figure}[!ht]
	...
	\caption{True item scores ($x$-axis) versus the sample mean across raters ($y$-axis). The left panel shows a scenario where there is large heterogeneity among the raters, and the performance of the sample mean is poor. In the right panel the raters are homogeneous, and the performance of the sample mean is much better.}
